...
(async function () {
    ...
    try {
        ...
        function netevent(sock, event) {
            ...
            argDv.setUint32(4, 0, true);            // ← alta dword a 0
        ...
        for (let attempt = 1; attempt <= NUM_ATTEMPT && !triplets; ++attempt) {
            ...
            // ── Drenar la cola por si quedó sucia de una ejecución previa ──
            // Usar un fd temporal evita tocar el fd que vamos a usar para el SET.
            {
